...
I. 
Cada vértice representa um Centro de Distribuição (Hub) ou Ponto de Entrega da 
empresa. 
II. 
III. 
IV. 
Cada aresta representa uma Rota Rodoviária ou Ligação Viária entre dois hubs. 
O peso da aresta indica o custo financeiro (em R$) para transportar uma unidade de 
carga por aquela rota — considerando distância, pedágio, combustível, tempo, entre 
outros fatores. 
A capacidade da aresta representa o limite máximo diário (em toneladas) que pode 
...
resultados no contexto logístico. 
